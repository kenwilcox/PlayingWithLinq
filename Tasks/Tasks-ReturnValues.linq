...
// Text From here - https://msdn.microsoft.com/en-us/library/windows/desktop/aa383604%28v=vs.85%29.aspx

var val = @"SCHED_S_TASK_READY
0x00041300
...
var lines = val.Split('\r');//.Dump();
for(int i = 0; i< lines.Length; i+= 3)
{
  Console.WriteLine("    {{ {0}, \"{1}\" }},", lines[i+1], lines[i+2].Trim());
}